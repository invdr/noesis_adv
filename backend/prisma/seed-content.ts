...
import { slugify, type RoomFormat } from "@gsk-tower/contracts";
...
const NEWS: NewsSeed[] = [
  {
    ...
    body: [
      "В честь священного месяца Рамадан ГСК TOWER предлагает специальные условия на покупку квартир во всех жилых комплексах группы. Акция действует в течение всего месяца и распространяется на готовые и строящиеся объекты.",
  ...
  },
  {
    ...
    body: [
      "Для участников и ветеранов специальной военной операции ГСК TOWER предусмотрел отдельную программу с индивидуальными условиями покупки и сопровождением на каждом этапе сделки.",
  ...
  },
  {
    ...
    excerpt:
      "Открыто бронирование квартир в жилых комплексах нового поколения от ГСК TOWER.",
    image: "image_67f78a9a261d6.webp",
    body: [
      "Открыто бронирование квартир в новых корпусах жилых комплексов ГСК TOWER. В продажу поступили студии и квартиры с одной, двумя и тремя комнатами — с продуманными планировками и возможностью объединения.",
  ...
  },
  {
    ...
    body: [
      "ГСК TOWER предоставляет беспроцентную рассрочку напрямую от застройщика на срок до 36 месяцев. Без участия банков, без процентов и скрытых переплат — вы платите ровно стоимость квартиры.",
  ...
  },
  {
    ...
    excerpt:
      "Засчитываем стоимость вашего жилья в счёт покупки квартиры в ЖК от ГСК TOWER.",
    image: "image_687e23156f398.webp",
    body: [
      "Программа Trade-in позволяет переехать в новую квартиру, не дожидаясь продажи старой. Мы оцениваем ваше текущее жильё и засчитываем его стоимость в счёт покупки квартиры в одном из жилых комплексов ГСК TOWER.",
  ...
  },
  {
    ...
    body: [
      "В жилых комплексах ГСК TOWER завершается благоустройство придомовых территорий. Дворы проектируются по принципу «двор без машин»: автомобили остаются на подземном паркинге и гостевых стоянках по периметру.",
