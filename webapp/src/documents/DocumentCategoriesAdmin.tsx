...
export function DocumentCategoriesAdmin() {
  return (
    <DictionaryAdmin
      ...
      description="Общий справочник категорий для всех ЖК (порядок задаёт раскладку на главной). Категорию нельзя удалить, пока в ней есть документы — используйте архив."
      addPlaceholder="Новая категория (напр. «Проектная документация»)"
    />
  );
}
