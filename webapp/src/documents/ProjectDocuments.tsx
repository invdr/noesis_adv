...
/**
 * Управление документами в карточке конструкции. Операции мгновенные (не в снимке
 * «Сохранить конструкцию»): добавление файла/ссылки, переименование, удаление. Документы
  ...
  return (
    <div>
      <p className="hint" style={{ marginTop: 0 }}>
        Документы добавляются и удаляются сразу (отдельно от кнопки «Сохранить конструкцию»).
