...
/**
 * Ход строительства в карточке ЖК: альбомы по месяцам с фотографиями.
 * Операции мгновенные (не в снимке «Сохранить ЖК»), как у документов:
  ...
  return (
    <div>
      <p className="hint" style={{ marginTop: 0 }}>
        Фотоотчёты по месяцам — показываются на странице ЖК на сайте (от новых к
