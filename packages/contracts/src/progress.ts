 ...
 * конструкции точечными операциями (как документы, не в снимке «Сохранить
 * конструкцию»). Один альбом на период (`год+месяц`), пустой альбом без фото
 * на публичный сайт не попадает.
 */
